...
<nav class="hk-breadcrumb" aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-light bg-transparent">
        ...
        <li class="breadcrumb-item active" aria-current="page">Detalhes do Checklist</li>
    </ol>
</nav>
...
<div class="container" >
    ...
    <div class="btn-group">
        <a href="<?=url('checklist')?>" class="btn btn-outline-success btn-sm" style="margin-top:-25px;float:right;text-transform:uppercase;"><i class="fa fa-arrow-left"></i> Voltar</a>
            ...
            <section class="hk-sec-wrapper">
                ...
                <div class="" style="border:1px solid #cacaca;padding:10px;">
                    ...
                    <div class="col-md-12" style="margin-top:0px;display: flex;justify-content: start;align-items:center;">  
                        ...
                        <span style="font-size:22px;">Inspeção Caminhão Canavieiro</span>
                    </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td style="background-color:#797979;font-weight:bold;font-size:15px;color:white;height: 60px !important;"><?=json_decode($checklist['checklist_json'])->motorista?>
                                </tr>
                            </tfoot>
