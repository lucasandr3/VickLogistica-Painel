    ...
    <div class="row">
      ...
      <div class="alert alert-info alert-dismissible fade show" role="alert">
        <strong><i class="icon fa fa-info"></i> <?=$name['nome_user']?></strong>
         - Nesta Tela Você Pode Acompanhar Receitas que você ira receber em parcelas.
      ...
      <div style="margin-left:0px;margin-bottom:5px;">
        <button class="btn btn-success" data-toggle="modal" data-target="#modal-default">
          <i class="fa fa-plus-square"></i> Nova Receita
        </button>
      </div>
            ...
            <?php foreach($list_reco as $item): ?>
                ...
                <td>
                  <button class="btn btn-success fundov btn-xs" style="margin-right:-4px;margin-left:3px">
                  ...
                  <?php for ($i=1; $i < $qtdp; $i++) { 
                      ...
                      $data_atual = $data;
                      echo "<button class='btn btn-success fundov btn-xs' style='margin-left:3px'>".
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header" style="background-color:#605ca8;border-radius:0px;">
                <h4 class="modal-title text-center" style="color:white">Cadastro de Parcelas</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true" style="color:white">x</span>
                </button>
              </div>
              <div class="modal-body">
            <form action="<?php echo BASE_URL ?>receitas/addReco" method="POST">
                <div class="row">
                <div class="form-group col">
                  ...
                  <label>Valor:</label>
                    <div class="input-group-prepend">
                      ...
                      <input type="text" class="form-control pull-right" name="valor" id="valorrec" placeholder="0.00">
                    </div>
                  </div>
                  ...
                  <label>V.Entrada:</label>
                    <div class="input-group-prepend">
                      ...
                      <input type="text" class="form-control pull-right" name="ventrada" value="0.00"  id="valorenrec" placeholder="0.00">
                    </div>
                  </div>
                  ...
                  <label>Juros:</label>
                    <div class="input-group-prepend">
                      ...
                      <input type="text" class="form-control pull-right" name="juro" value="0.0" id="jurorec" placeholder="0.0">
                    </div>
                  </div>
                </div>
